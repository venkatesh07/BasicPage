...
public class BaseClass {
	...
	public static void navigatebrowserwithvalidur(String Browser) {
		...
		try {
			if (Browser.equals("Chrome")) {
				...
				String chromepath = System.getProperty("user.dir") + "//BrowserDriver//chromedriver.exe";
				...
				String Firefoxpath = System.getProperty("user.dir") + "//BrowserDriver//geckodriver.exe";
				...
				String IEPath = System.getProperty("user.dir") + "//BrowserDriver//IEDriverServer.exe";
	...
	public static void gettestdata() {
		...
		@AfterMethod
		public static void Screenshotadded(ITestResult result) throws IOException {
